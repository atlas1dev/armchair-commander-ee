...
public class ProductBar : MonoBehaviour {
    ...
    void Start() {
        ...
        airportTroopTypes.Add("Attack Helicopter", 0);
        airportTroopTypes.Add("Strafing Run", 1);
        airportTroopTypes.Add("Bombing Run", 2);
        airportTroopTypes.Add("Paratrooper Deployment", 3);
        airportTroopTypes.Add("Strategic Run", 4);
        ...
        troopIndustryRequirements.Add("Attack Helicopter", 0);
        ...
        troopIndustryRequirements.Add("Railroad", 0);
        ...
        troopAirportRequirements.Add("Attack Helicopter", 1);
        ...
        troopAirportRequirements.Add("Railroad", 0);
        ...
        troopNuclearRequirements.Add("Attack Helicopter", 0);
        ...
        troopNuclearRequirements.Add("Railroad", 0);
        ...
        troopNames = new string[][] {
            ...
            new string[] {"Attack Helicopter", "Strafing Run", "Bombing Run", "Paratrooper Deployment", "Strategic Run"},
            new string[] {"Railroad", "Bunker", "Turret", "Coastal Turret", "Missile Launcher" },
        ...
        troopIndustryCosts = new int[][] {
            ...
            new int[] {20, 35, 60, 60},
            new int[] {20, 20, 25, 15, 35},
            new int[] {15, 25, 30, 35, 125},
    ...
    public void purchaseProduct(int productId) {
        if (selectedCategory == PurchaseCategory.nuclear) {
            ...
            if (troopNames[(int)selectedCategory][productId] != "Railroad") {
                controller.spawnSoldier(t.coordinate, controller.playerCountry, controller.countriesIsAxis[controller.playerCountry], troopTypes[troopNames[(int)selectedCategory][productId]], 0, stackSize, false);
                t.occupant.moved = true;
                t.occupant.attacked = true;
                controller.buildButton.position = new Vector3(-1000f, controller.buildButton.position.y, 0f);
                controller.canBuild = false;
            } else {
                t.terrain = Terrain.railroad;
			    t.updateTerrain();
            }
            StartCoroutine(delayHideUI());
        }
    ...
    void Update() {
        ...
        if (controller.selectedBuildTile == null && controller.selectedCity != null && !controller.selectedCity.isPort) {
            ...
            if ((controller.selectedCity != null && controller.selectedCity.currentTile.occupant != null) || controller.producon) {
                ...
                if (controller.selectedCity.currentTile.city.airportTier >= 1 && controller.producon) {
                    categoryButtons[3].interactable = false;
                    changePurchaseCategory(3);
                } else if (controller.selectedCity.currentTile.city.nuclearTier >= 1 && controller.producon) {
                    categoryButtons[4].interactable = false;
                    changePurchaseCategory(6);
                }
            }
            if (controller.selectedCity != null && controller.selectedCity.currentTile.city.airportTier <= 0) {
                categoryButtons[3].gameObject.SetActive(false);
            }
            if (controller.selectedCity != null && controller.selectedCity.currentTile.city.nuclearTier <= 0) {
                categoryButtons[4].gameObject.SetActive(false);
            }
            if (controller.selectedCity != null && controller.selectedCity.currentTile.city.factoryTier <= 0) {
                categoryButtons[1].gameObject.SetActive(false);
                categoryButtons[2].gameObject.SetActive(false);
            }
