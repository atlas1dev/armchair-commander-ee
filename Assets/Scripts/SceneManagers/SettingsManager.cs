...
public class SettingsManager : MonoBehaviour {
	...
	public Toggle policyToggle, animationToggle;
	...
	void Update() {
		...
		myPlayerPrefs.SetInt("animationsOn", animationToggle.isOn ? 1 : 0);
	}
	bool started = false;
	...
	void Start() {
		...
		animationToggle.isOn = myPlayerPrefs.GetInt("animationsOn") == 1;
