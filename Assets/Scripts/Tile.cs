...
public class Tile : MonoBehaviour {
    ...
    public SpriteRenderer topTrapezoid, bottomTrapezoid, leftCutout, rightCutout, flagImage, radiationRenderer, smokeRenderer; //flag image is for water tile in map editor
    public GameObject borderPrefab, beachPrefab;
    ...
    IEnumerator delayStart() {
        ...
        if (terrain != Terrain.water) {
            if (lowerLeft != null && lowerLeft.terrain == Terrain.water) {
                borderPrefabs.Add(Instantiate(beachPrefab, new Vector3(transform.position.x, transform.position.y, transform.position.z - 0.01f), Quaternion.Euler(0f, 0f, -60f)));
                if (bottomTrapezoid.enabled) {
                    borderPrefabs.Add(Instantiate(beachPrefab, new Vector3(transform.position.x, transform.position.y - (top.transform.position.y - transform.position.y), transform.position.z - 0.01f), Quaternion.Euler(0f, 0f, -120f)));
                }
                if (lowerLeft.topTrapezoid.enabled) {
                    borderPrefabs.Add(Instantiate(beachPrefab, new Vector3(transform.position.x, transform.position.y, transform.position.z - 0.01f), Quaternion.Euler(0f, 0f, -120)));
                }
            }
            if (lowerRight != null && lowerRight.terrain == Terrain.water) {
                borderPrefabs.Add(Instantiate(beachPrefab, new Vector3(transform.position.x, transform.position.y, transform.position.z - 0.10f), Quaternion.Euler(0f, 0f, 60f)));
                if (bottomTrapezoid.enabled) {
                    borderPrefabs.Add(Instantiate(beachPrefab, new Vector3(transform.position.x, transform.position.y - (top.transform.position.y - transform.position.y), transform.position.z - 0.01f), Quaternion.Euler(0f, 0f, 120f)));
                }
            ...
            if (upperLeft != null && upperLeft.terrain == Terrain.water) {
                borderPrefabs.Add(Instantiate(beachPrefab, new Vector3(transform.position.x, transform.position.y, transform.position.z - 0.01f), Quaternion.Euler(0f, 0f, -120f)));
                if (upperLeft.bottomTrapezoid.enabled) {
                    borderPrefabs.Add(Instantiate(beachPrefab, new Vector3(transform.position.x, transform.position.y, transform.position.z - 0.01f), Quaternion.Euler(0f, 0f, -60f)));
                }
                if (topTrapezoid.enabled) {
                    borderPrefabs.Add(Instantiate(beachPrefab, new Vector3(transform.position.x, transform.position.y + (transform.position.y - bottom.transform.position.y), transform.position.z - 0.01f), Quaternion.Euler(0f, 0f, -60)));
                }
            }
            ...
            if (top != null && top.terrain == Terrain.water) {
                borderPrefabs.Add(Instantiate(beachPrefab, new Vector3(transform.position.x, transform.position.y, transform.position.z - 0.01f), Quaternion.Euler(0f, 0f, 180f)));
                if (leftCutout.enabled) {
                    borderPrefabs.Add(Instantiate(beachPrefab, new Vector3(transform.position.x - 0.2f, transform.position.y, transform.position.z - 0.01f), Quaternion.Euler(0f, 0f, 180f))); 
                }
            ...
            if (bottom != null && bottom.terrain == Terrain.water) {
                borderPrefabs.Add(Instantiate(beachPrefab, new Vector3(transform.position.x, transform.position.y, transform.position.z - 0.01f), Quaternion.identity));
                if (rightCutout.enabled) {
                    borderPrefabs.Add(Instantiate(beachPrefab, new Vector3(transform.position.x + 0.2f, transform.position.y, transform.position.z - 0.01f), Quaternion.Euler(0f, 0f, 0f)));
                }
                if (leftCutout.enabled) {
                    borderPrefabs.Add(Instantiate(beachPrefab, new Vector3(transform.position.x - 0.2f, transform.position.y, transform.position.z - 0.01f), Quaternion.Euler(0f, 0f, 0f)));
                }
    ...
    public void updateTileColor() {
        if (terrain == Terrain.water) { 
            defaultTileColor = new Color(0.19f, 0.60f, 0.77f, 1f); 
        } else {
            defaultTileColor = country switch {
                "Soviet" => new Color(0.9f, 0.67f, 0.67f, 1f),
                "NeutralSoviet" => new Color(0.8f, 0.67f, 0.681f, 1f),
                "Soviet2" => new Color(0.98f, 0.62f, 0.62f, 1f),
                "German" => new Color(0.61f, 0.6f, 0.62f, 1f),
                "Austria" => new Color(0.75f, 0.52f, 0.62f, 1f),
                "Czechoslovakia" => new Color(0.52f, 0.57f, 0.92f, 1f),
                ...
                "RepublicanSpain" => new Color(0.97f, 0.6f, 0.67f, 1f),
                "FascistSpain" => new Color(0.52f, 0.53f, 0.621f, 1f),
                "NeutralSpain" => new Color(0.52f, 0.53f, 0.621f, 1f),
                "Switzerland" => new Color(0.24f, 0.23f, 0.29f, 1f),
                "Ireland" => new Color(0.65f, 0.82f, 0.83f, 1f),
                "Iran" => new Color(0.65f, 0.82f, 0.87f, 1f),
                "Iraq" => new Color(0.65f, 0.92f, 0.51f, 1f),
                "CommieIraq" => new Color(0.601f, 0.82f, 0.81f, 1f),
                "Sweden" => new Color(0.66f, 0.817f, 0.86f, 1f),
                "Portugal" => new Color(0.65f, 0.8f, 0.83f, 1f),
                "Latvia" => new Color(0.68f, 0.85f, 0.83f, 1f),
                "Lithuania" => new Color(0.67f, 0.7f, 0.83f, 1f),
                "Estonia" => new Color(0.62f, 0.76f, 0.79f, 1f),
                "Poland" => new Color(0.3f, 0.2f, 0.2f, 1f),
                "CommiePoland" => new Color(0.5f, 0.2f, 0.2f, 1f),
                "HomeArmyPoland" => new Color(0.3f, 0.26f, 0.23f, 1f),
                "NorthKorea" => new Color(0.3f, 0.27f, 0.2f, 1f),
                "SouthKorea" => new Color(0.7f, 0.8f, 0.92f, 1f),
                "Turkey" => new Color(0.3f, 0.2f, 0.27f, 1f),
                "SaudiArabia" => new Color(0.3f, 0.21f, 0.97f, 1f),
                "India" => new Color(0.3f, 0.21f, 0.35f, 1f),
                "NatoIndia" => new Color(0.3f, 0.27f, 0.35f, 1f),
                "Pakistan" => new Color(0.3f, 0.21f, 0.79f, 1f),
                "Egypt" => new Color(0.25f, 0.9f, 0.79f, 1f),
                "Liberia" => new Color(0.27f, 0.15f, 0.29f, 1f),
                "Ethiopia" => new Color(0.35f, 0.9f, 0.95f, 1f),
                "Albania" => new Color(0.35f, 0.35f, 0.62f, 1f),
                "SouthAfrica" => new Color(0.050f, 0.450f, 0.015f, 1f),
                "NatoTurkey" => new Color(0.25f, 0.2700000f, 0.225f, 1f),
                "Vietnam" => new Color(0.25f, 0.298f, 0.21f, 1f),
                "Finland" => new Color(0.7f, 0.86f, 0.85f, 1f),
                "SouthVietnam" => new Color(0.2f, 0.35f, 0.85f, 1f),
                "Brazil" => new Color(0.2f, 0.76f, 0.15f, 1f),
                "Argentina" => new Color(0.1f, 0.76f, 0.8f, 1f),
                "Malaysia" => new Color(0.2f, 0.36f, 0.57f, 1f),
                "CommieGreece" => new Color(0.9f, 0.15f, 0.25f, 1f),
                "Singapore" => new Color(0.89f, 0.75f, 0.832f, 1f),
                "Chile" => new Color(0.59f, 0.75f, 0.832f, 1f),
                "Colombia" => new Color(0.59f, 0.65f, 0.732f, 1f),
                "Indonesia" => new Color(0.39f, 0.55f, 0.132f, 1f),
                "Mexico" => new Color(0.2f, 0.25f, 0.37f, 1f),
                "Cuba" => new Color(0.7f, 0.2f, 0.17f, 1f),
                "Canada" => new Color(0.789f, 0.6720201f, 0.85f, 1f),
                "Greece" => new Color(0.67f, 0.79f, 0.9f, 1f),
                "Australia" => new Color(0.37f, 0.59f, 0.98f, 1f),
                "NewZealand" => new Color(0.67f, 0.72f, 0.98f, 1f),
                "Bulgaria" => new Color(0.1f, 0.76f, 0.1f, 1f),
                "Romania" => new Color(0.8f, 0.6f, 0.17f, 1f),
                "Hungary" => new Color(0.71f, 0.71f, 0.35f, 1f),
                "Yugoslavia" => new Color(0.8f, 0.72f, 0.7f, 1f),
                "Serbia" => new Color(0.99f, 0.72f, 0.7f, 1f),
                "Croatia" => new Color(0.75f, 0.62f, 0.52f, 1f),
                "Belgium" => new Color(0.25f, 0.35f, 0.85f, 1f),
                "UK" => new Color(0.1f, 0.72f, 0.78f),
                "NatoUK" => new Color(0.17f, 0.82f, 0.78f),
                "NeutralUK" => new Color(0.1f, 0.78f, 0.61f),
                "Italy" => new Color(0.8f, 0.2f, 0.7f),
                "Denmark" => new Color(0.86f, 0.2f, 0.85f),
                "Luxembourg" => new Color(0.82f, 0.25f, 0.7f),
                "Netherlands" => new Color(0.89f, 0.351f, 0.617002f),
                "Norway" => new Color(0.82f, 0.25f, 0.9f),
                "ROC" => new Color(0.67f, 0.79f, 0.97f, 1f),
                "NatoROC" => new Color(0.57f, 0.79f, 0.97f, 1f),
                "ChineseGuangxi" => new Color(0.25f, 0.72f, 0.52f, 1f),
                "ChineseShanxi" => new Color(0.67f, 0.52f, 0.920f, 1f),
                "ChineseSinkiang" => new Color(0.67f, 0.79f, 0.625f, 1f),
                "ChineseTibet" => new Color(0.73f, 0.67f, 0.97f, 1f),
                "ChineseXibeiSanma" => new Color(0.57f, 0.89f, 0.97f, 1f),
                "ChineseYunnan" => new Color(0.87f, 0.67f, 0.97f, 1f),
                "Mongolia" => new Color(0.87f, 0.59f, 0.97f, 1f),
                "USA" => new Color(0.1f, 0.72f, 0.97f, 1f),
                "NatoUSA" => new Color(0.17f, 0.82f, 0.9f, 1f),
                "France" => new Color(0.67f, 0.572f, 0.97f, 1f),
                "NatoFrance" => new Color(0.67f, 0.572f, 0.912f, 1f),
                "Israel" => new Color(0.602f, 0.572f, 0.912f, 1f),
                "NeutralFrance" => new Color(0.63f, 0.578f, 0.95f, 1f),
                "Thailand" => new Color(0.3f, 0.39f, 0.52f, 1f),
                "NeutralThailand" => new Color(0.325f, 0.39f, 0.52f, 1f),
                "Japan2" => new Color(0.35f, 0.81f, 0.25f, 1f),
                "Manchukuo" => new Color(0.25f, 0.9f, 0.9f, 1f),
                "Mengkukuo" => new Color(0.15f, 0.85f, 0.7f, 1f),
                "PRC" => new Color(0.98f, 0.67f, 0.63f, 1f),
                "PRCNew" => new Color(1f, 0.52f, 0.63f, 1f),
                "PuppetROC" => new Color(0.67f, 0.701f, 0.93f, 1f),
                "Japan" => new Color(0.3f, 0.8f, 0.35f, 1f),
            };
        }
    ...
    void Update() {
        ...
        if (smokeLeft > 0) {
            if (!smokeRenderer.enabled)
                smokeRenderer.enabled = true;
        } else if (smokeRenderer.enabled && smokeLeft <= 0) {
